        ...
        <header className="flex h-16 shrink-0 justify-between border-b px-4">
            <div className="flex items-center gap-3">
                ...
                <ul className="flex gap-3 text-sm font-medium">
                    <li onClick={() => setSelectedCategory("All")} className={`border cursor-pointer rounded-lg gap-3 flex items-center px-3 py-2 ${selectedCategory === "All" ? "bg-[#1B2537] text-white" : ""}`}>
                        <span>All</span>
                    ...
                    {categories.map((category) => (
                        <li onClick={() => setSelectedCategory(category)} className={`border cursor-pointer rounded-lg gap-3 flex items-center px-3 py-2 ${selectedCategory === category ? "bg-[#1B2537] text-white" : ""}`}>
                            <span>{category}</span>
